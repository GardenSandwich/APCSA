package Unit_5._5_9.fractionmath;
...
public class Fraction {
    ...
    public void addFraction(Fraction other){
        this.numerator = FractionMath.add(this, other).getNumerator();
        this.denominator = FractionMath.add(this, other).getDenominator();
    }
    ...
    public void multiplyFraction(Fraction other){
        this.numerator = FractionMath.multiply(this, other).getNumerator();
        this.denominator = FractionMath.multiply(this, other).getDenominator();
    }
